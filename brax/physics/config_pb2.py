...
_COLLIDER_MATERIAL = _descriptor.Descriptor(
  ...
  oneofs=[
    _descriptor.OneofDescriptor(
      name='_friction', full_name='brax.Collider.Material._friction',
...
_COLLIDER_MATERIAL.oneofs_by_name['_friction'].fields.append(
  _COLLIDER_MATERIAL.fields_by_name['friction'])
_COLLIDER_MATERIAL.fields_by_name['friction'].containing_oneof = _COLLIDER_MATERIAL.oneofs_by_name['_friction']
